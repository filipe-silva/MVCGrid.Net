...
namespace MVCGrid.Models
{
    public class GridDefaults : IMVCGridDefinition
    {
        public GridDefaults()
        {
            ...
            RenderingEngines.Add(new RenderingEngineSetting("BootstrapRenderingEngine", "MVCGrid.Rendering.BootstrapRenderingEngine, MVCGrid"));
            RenderingEngines.Add(new RenderingEngineSetting("Export", "MVCGrid.Rendering.CsvRenderingEngine, MVCGrid"));
        ...
        public Type RenderingEngine {
            ...
            set {
                ...
                RenderingEngines.Add(new RenderingEngineSetting(name, fullyQualifiedName));
