...
namespace MVCGrid.Models
{
    public class MVCGridBuilder<T1>
    {
        ...
        public MVCGridBuilder<T1> WithRenderingEngine(Type renderingEngineType)
        {
            ...
            GridDefinition.RenderingEngines.Add(new RenderingEngineSetting(name, fullyQualifiedName));
        ...
        {
            GridDefinition.RenderingEngines.Add(new RenderingEngineSetting(name, type));
            return this;
        }
